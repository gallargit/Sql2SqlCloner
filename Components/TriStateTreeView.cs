...
namespace Sql2SqlCloner.Components
{
    ...
    public class TriStateTreeView : System.Windows.Forms.TreeView
    {
        ...
        // </remarks>
        public enum CheckedState { UnChecked, Checked, Mixed };
        ...
        // </remarks>
        public enum TriStateStyles { Standard = 0, Installer }
        ...
        // </summary>
        protected void UpdateChildState(System.Windows.Forms.TreeNodeCollection NodesCollection, int StateImageIndex, bool Checked, bool ChangeUninitialisedNodesOnly)
        {
            foreach (System.Windows.Forms.TreeNode tnChild in NodesCollection)
            {
        ...
        {
            // Node needs to check all of its children to see if any of them are ticked or mixed
            if (tn == null)
            {
                return;
            }
            ...
            // The parent needs to know how many of its children are Checked or Mixed
        ...
        protected override void OnNodeMouseClick(System.Windows.Forms.TreeNodeMouseClickEventArgs e)
        {
            ...
            if (HitTest(e.X, e.Y).Location != System.Windows.Forms.TreeViewHitTestLocations.StateImage)
            {
                return;
            }
